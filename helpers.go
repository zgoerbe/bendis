...
// RandomString generates a radom string length n from values in the const randomString
func (b *Bendis) RandomString(n int) string {
...
func (b *Bendis) CreateDirIfNotExist(path string) error {
	const mode = 0755
...
func (b *Bendis) CreateFileIfNotExist(path string) error {
